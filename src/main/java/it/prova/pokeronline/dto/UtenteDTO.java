...
public class UtenteDTO {
	...
	public void setDateCreated(LocalDate dateCreazione) {
...
//			boolean includeAgenda,Utente utenteModel
		Utente result = new Utente(this.id,this.nome, this.cognome, this.username, this.password,
				this.dateCreazione, this.stato);
