...
import it.prova.pokeronline.dto.UtenteDTOAggiornato;
...
import it.prova.pokeronline.web_api.exception.UtenteNotFoundException;
...
public class UtenteControllo {
	...
	@PutMapping("/{id}")
	public UtenteDTO update(@Valid @RequestBody UtenteDTOAggiornato utenteInput, @PathVariable(required = true) Long id) {
